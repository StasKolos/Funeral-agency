        ...
        <div className={clsx('content-wrapper', 'content')}>
            ...
            <div className={s['info-wrapper']}>
                ...
                <div className={s['phone-info']}>
                    <h3>Телефон для экстренных вызовов и консультаций:</h3>
                ...
                <div className={s['address-info']}>
                    <h3>Наш адрес для личного визита:</h3>
                ...
                <div className={s['schedule-info']}>
                    <h3>График работы:</h3>
                    <p>Круглосуточно, без выходных и перерывов</p>
                    <p>
                        Телефон всегда активен. Если звоните ночью, не сомневайтесь - мы обязательно
                        ответим и поможем.
                    </p>
                </div>
            </div>
