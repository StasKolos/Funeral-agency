...
export const SITE_DESCRIPTION = inlineText`
    Ритуальное агентство в Хабаровске: организация похорон, кремация, Транспортировка тела умершего,
...
export const SITE_ROUTES = {
    ...
    services: createSectionRoute(
        ...
        'Услуги',
        inlineText`
            Организация похорон, кремация, Транспортировка тела умершего и сопровождение
    ...
    cremationPaidService: createSectionRoute(
        ...
        inlineText`
            Кремация в Хабаровске: гроб, урна, катафалк, бригада, копка могилы под урну,
    ...
    cargoService: createSectionRoute(
        ...
        inlineText`
            Транспортировка тела умершего из Хабаровска и в Хабаровск: документы, бальзамирование,
    ...
    products: createSectionRoute(
        ...
        inlineText`
            Каталог ритуальных товаров и принадлежностей в Хабаровске: памятники, венки,
            гробы, кресты, корзины, вазы и товары для благоустройства захоронений.
        `,
    ),
