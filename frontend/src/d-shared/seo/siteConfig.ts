...
export const SITE_ROUTES = {
    ...
    funeralEconomyService: createSectionRoute(
        '/funeral/economy',
        'Похороны эконом в Хабаровске от 21 000 ₽',
        inlineText`
            Похороны эконом в Хабаровске от 21 000 ₽: ситцевый гроб, катафалк,
            бригада, копка могилы, временный памятник и документы. Звоните 24/7.
        `,
        '21000',
    ),
    funeralEconomyPlusService: createSectionRoute(
        '/funeral/economy-plus',
        'Похороны эконом-плюс в Хабаровске от 40 000 ₽',
        inlineText`
            Похороны эконом-плюс в Хабаровске от 40 000 ₽: бархатный гроб,
            памятник из мраморной крошки, катафалк, бригада, могила и документы.
        `,
        '40000',
    ),
    funeralStandardService: createSectionRoute(
        '/funeral/standard',
        'Похороны стандарт в Хабаровске от 65 000 ₽',
        inlineText`
            Похороны стандарт в Хабаровске от 65 000 ₽: бархатный гроб,
            гранитный памятник 800 мм, транспорт, бригада, документы и сопровождение семьи.
        `,
        '65000',
    ),
    funeralPremiumService: createSectionRoute(
        '/funeral/premium',
        'Похороны премиум в Хабаровске от 90 000 ₽',
        inlineText`
            Похороны премиум в Хабаровске от 90 000 ₽: лакированный гроб,
            гранитный памятник, транспорт, бригада, документы и достойное прощание.
        `,
        '90000',
    ),
    ...
    cremationFreeService: createSectionRoute(
        '/cremation/free',
        'Бесплатная кремация в Хабаровске',
        inlineText`
            Бесплатная кремация в Хабаровске: проверим право на кремацию за 0 ₽,
            подскажем документы, поможем с моргом и передачей вещей через специалиста.
        `,
        '0',
    ),
    cremationPaidService: createSectionRoute(
        '/cremation/paid',
        'Кремация в Хабаровске: цена',
        inlineText`
            Кремация в Хабаровске от 19 000 ₽: гроб, урна, катафалк,
            бригада, место под урну, оформление документов и сопровождение семьи.
        `,
        '19000',
    ),
    ...
    graveImprovementService: createSectionRoute(
        ...
        inlineText`
            Благоустройство могил в Хабаровске от 2 800 ₽: уборка, замеры,
